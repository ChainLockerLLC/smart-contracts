...
contract EthLockerTest is Test {
    ...
    //assigned and used in 'testConditionedExecute'
    ...
    // testing basic functionalities: refund, no valueCondition (separately tested in 'testConditionedExecute'), identified buyer
