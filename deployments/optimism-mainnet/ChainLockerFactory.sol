/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-09-06
*/
 ...
 **/
/** @notice non-custodial smart escrow contract for ETH-denominated transaction on Optimism, supporting:
...
contract EthLocker is ReentrancyGuard, SafeTransferLib {
    ...
    // Receipt.sol contract address, Optimism mainnet
 ...
 * @author      o=o=o=o=o ChainLocker LLC o=o=o=o=o
 **/
/** @notice non-custodial smart escrow contract using ERC20 tokens on Optimism, supporting:
 * partial or full deposit amount
 * refundable or non-refundable deposit upon expiry
...
contract TokenLocker is ReentrancyGuard, TokenSafeTransferLib {
    ...
    // Receipt.sol contract address, Optimism
    IReceipt internal constant RECEIPT =
        IReceipt(0xf838D6829fcCBedCB0B4D8aD58cb99814F935BA8);
...
contract ChainLockerFactory {
    ...
    /// @notice Chainalysis Inc.'s Optimism mainnet sanctions oracle, see https://go.chainalysis.com/chainalysis-oracle-docs.html for contract addresses
